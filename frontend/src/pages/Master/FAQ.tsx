  ...
  return (
    <>
      <Breadcrumb pageName="Master FAQ" />
          <span className='font-bold '>Select type <span className='text-meta-1'>*</span></span>
        ...
        <div>
          <div className="inline-flex rounded-md shadow-sm" role="group mt-1">
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-transparent border border-gray-900 rounded-r-lg hover:bg-gray-900  focus:z-10 focus:ring-2 focus:ring-primary   "
            >
              <svg
                className="w-3 h-3 me-2"
                aria-hidden="true"
