...
const currentItems = filteredData.slice(indexOfFirstItem, indexOfLastItem);
  ...
  return (
    <>
      ...
      {loading ? <Loader/> : currentItems.length === 0 || null ? (<h2 className='flex justify-center items-center text-xl font-extrabold'>No Any Record Found.</h2>): ( <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            ...
            <tbody>          
              {currentItems.map((item: any) => (
                <tr key={item.id}>
                  ...
                  <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                    <p className="text-black dark:text-white">{item.mobile}</p>
                  </td>
